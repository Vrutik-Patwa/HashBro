  ...
  return (
    <div className="py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-center mb-4">Hasbro Toy Categories</h1>
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Explore iconic Hasbro brands — from Monopoly and Transformers to Nerf and Play-Doh.
        </p>
              ...
              <div className="relative aspect-[16/10]">
                ...
                <div className="absolute bottom-0 p-6 text-white">
                  ...
                  {"brands" in cat && cat.brands && (
                    <p className="text-xs text-hasbro-aqua mt-2 font-semibold">{cat.brands.join(" · ")}</p>
                  )}
                  <span className="inline-flex items-center gap-1 mt-3 text-sm font-semibold text-hasbro-orange">
                    {cat.productCount} products <ArrowRight className="h-4 w-4" />
                  </span>
                </div>
              </div>
            </Link>
